...
{
    public class LanzamientosModel : PageModel
    {
        private ILanzamientosPresentacion? iPresentacion = null;

        public LanzamientosModel(ILanzamientosPresentacion iPresentacion)
        {
            try
            {
                this.iPresentacion = iPresentacion;
                Filtro = new Lanzamientos();
            }
            catch (Exception ex)
            {
