...
-- Tabla de relación Jugadores-Bolas (usualmente no lleva campos de imagen propios)
...
-- Tabla de relación Jugadores-Lanzamientos (usualmente no lleva campos de imagen propios)
...
-- Tabla de relación Jugadores-Partidas (usualmente no lleva campos de imagen propios)
...
-- NUEVA TABLA: Tabla de Auditoría
...
-- INSERTS (Los campos ImagenData e ImagenMimeType serán NULL por defecto para estos datos de ejemplo)
...
(3, 3, 'CC3', 3, 270, 0),
(4, 4, 'DD4', 4, 220, 0),
(3, 4, 'DD4', 1, 280, 1), -- Jugador 3 también jugó en partida 4
(5, 5, 'EE5', 5, 290, 1);
GO
